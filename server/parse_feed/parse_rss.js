...
let _sortOldBlogPosts;
let _totalArticlesCount;
let _seoFriendly;
let _addReviewImage;
let _newBlogPosts;
let _mergeBlogPosts;
...
const RSSClass = function() {
  ...
  _closeBlogComments = (data) => {
    ...
    let oldPosts = this.oldBlogPosts;
...
module.exports = function(app) {
  ...
  app.get('/api/oldBlog/get', function(req, res) {
    ...
    fs.access(global.__base + 'server/blogposts.json', (err) => {
    ...
    if (OldBlogPosts.cache && OldBlogPostTotal.cache) {
      ...
      OldBlogFeed.parseFeed(global.__base + 'server/blogposts.json', function(data) {
